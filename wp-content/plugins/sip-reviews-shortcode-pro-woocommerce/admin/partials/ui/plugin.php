...
$extensions = array(
    '1' => (object) array(
        ...
        'desc'      => __( 'Display real time proof of your sales and customers.<br>', 'sip-reviews-shortcode' ),
    ),
    '2' => (object) array(
        ...
        'desc'      => __( 'Bundle maker with real time offers.<br><br>', 'sip-reviews-shortcode' ),
    ),
    '3' => (object) array(
        ...
        'desc'      => __( 'Display product reviews in any post/page with a shortcode.', 'sip-reviews-shortcode' ),
    ),
    '4' => (object) array(
        'image_url' => $src_image . 'icon-advanced-email.png',
        'url'       => SIP_AENWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_RSWC_VERSION .'&utm_campaign=' .SIP_RSWC_UTM_CAMPAIGN,
        'title'     => SIP_AENWC_PLUGIN,
        'desc'      => __( 'Powerful email automation.', 'sip-social-proof' ),
    ),
    '5' => (object) array(
      'image_url' => $src_image . 'icon-cookie-check.png',
      'url'       => SIP_CCWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_RSWC_VERSION .'&utm_campaign=' .SIP_RSWC_UTM_CAMPAIGN,
      'title'     => SIP_CCWC_PLUGIN,
      'desc'      => __( 'Encourage visitors to enable cookies so you don’t lose sales.', 'sip-reviews-shortcode' ),
    ),
);
    ...
    foreach ( (array) $extensions as $i => $extension ) {
        ...
        <p><?php echo $description ?></p>
			...
			<div class="sip-addon-action">
				<a class="button button-primary" title="<?php echo $title; ?>" href="<?php echo $url; ?>" target="_blank"><?php _e('Learn more' , 'sip-reviews-shortcode');?></a>
			</div>
