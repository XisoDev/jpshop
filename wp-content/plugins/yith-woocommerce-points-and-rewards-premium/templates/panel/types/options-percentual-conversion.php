...
foreach ( $currencies as $current_currency ) :
	...
	$discount = ( isset( $db_value[ $current_currency ]['discount'] ) ) ? $db_value[ $current_currency ]['discount'] : $db_value['discount'];
    ...
    <div id="<?php echo $id ?>-container" <?php echo $deps_html; ?>
        ...
        <div class="option">
            ...
            <input type="number" name="<?php echo $name ?>[discount]" step="1" min="0" id="<?php echo $id ?>-discount"
                   value="<?php echo esc_attr( $discount ) ?>"/>
            <span><?php _e('%', 'yith-woocommerce-points-and-rewards' ) ?></span>
        </div>
