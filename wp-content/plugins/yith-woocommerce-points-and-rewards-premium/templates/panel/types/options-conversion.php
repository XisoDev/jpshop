...
foreach ( $currencies as $current_currency ) :
	...
	$points = ( isset( $db_value[ $current_currency ]['points'] ) ) ? $db_value[ $current_currency ]['points'] : ( isset( $db_value['points'] ) ? $db_value['points'] : '') ;
	$money = ( isset( $db_value[ $current_currency ]['money'] ) ) ? $db_value[ $current_currency ]['money'] : ( isset( $db_value['money'] ) ? $db_value['money'] : '');
