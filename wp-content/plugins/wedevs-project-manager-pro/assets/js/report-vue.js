    ...
    var vm = new Vue( {
        ...
        methods: {
            ...
            printReport: function() {
                ...
                var styles = jQuery('head').find('link');

                var iframe = $('<iframe/>', {
                        id   : 'content-to-be-printed',
                        name : 'content-to-be-printed',
                        style: 'display:none',
                    }),
                    iframeDocument;
                ...
                iframeDocument = iframe[0].contentWindow || iframe[0].contentDocument.document || iframe[0].contentDocument;
                ...
                setTimeout(function () {
                    window.frames["content-to-be-printed"].focus();
                    window.frames["content-to-be-printed"].print();
                    iframe.remove();
                }, 500);
            }
        },
