...
module.exports = '<div class="cpm-blank-template file-list">\n    <div class="cpm-content" >\n        <h2 class="cpm-page-title">{{text.document_n_file}}</h2>\n\n        <p>\n           {{text.file_page_intro}}\n        </p>\n\n        <div class="cpm-list-content">\n            <h2 class="cpm-page-title cpm-why-for">{{text.benefits_of_doc}}</h2>\n\n            <ul class="cpm-list">\n                <li>{{text.integrate_easily}}</li>\n                <li>{{text.shared_storage}}</li>\n                <li>{{text.file_share_privacy}}</li>\n            </ul>\n        </div>\n\n    </div>\n</div>';
...
// Maxxin
    var myMixin = {
        ...
        methods: {
            ...
            readDoc: function (doc) {
                ...
                jQuery('#cpm-upload-container-dc .moxie-shim').css({'left': '85px', 'top':'0px', 'width':'70px', 'height':'30px'})
                this.checkDocIcon(vm.viewDoc.doclink);
            },
            checkDocIcon: function (dlink) {

                var link = dlink;
                var icon = CPM_pro_files.base_url + "/assets/images/others.svg";
                var g = link.search(/google.com/i);
                if (g != -1) {
                    icon = CPM_pro_files.base_url + "/assets/images/google_drive.svg";
                    // check google docs
                    g = link.search(/document/i);
                    if (g != -1) {
                        icon = CPM_pro_files.base_url + "/assets/images/google_docs.svg";
                    }

                    g = link.search(/spreadsheets/i);
                    if (g != -1) {
                        icon = CPM_pro_files.base_url + "/assets/images/google_spreadsheets.svg";
                    }

                    g = link.search(/presentation/i);
                    if (g != -1) {
                        icon = CPM_pro_files.base_url + "/assets/images/google_presentation.svg";
                    }
                ...
                if (g != -1) {
                    icon = CPM_pro_files.base_url + "/assets/images/dropbox.svg";
                }

                g = link.search(/live.com/i);
                if (g != -1) {
                    icon = CPM_pro_files.base_url + "/assets/images/sky_drive.svg";
                }
    ...
    var modal = Vue.component('modal', {
        ...
        props: ['show',  'folderLink', 'modalwide', 'baseurl', 'folderName', 'current_project', 'parent', 'folderlist', 'privacy', 'formAction', 'empty_filesfolder'],
        methods: {
    ...
    var readdocmodal = Vue.component('readdocmodal', {
        template: require('./../html/files/readdocmodal.html'),
        mixins: [myMixin],
        props: ['show', 'currentIcon', 'modalwide', 'current_project', 'wp_nonce', 'revisionMode', 'readDocModal', 'viewDoc', 'docEidted', 'docFormShow', 'comments', 'docRevisions'],
        ready: function () {
        ...
        methods: {
            ...
            updateDoc: function () {
                ...
                jQuery.post(CPM_Vars.ajaxurl, data, function (res) {
                    ...
                    var d = res.document;
                    if (res.success == true) {
                        self.viewDoc.name = JSON.stringify(d.name);
                        self.viewDoc.full_name = JSON.stringify(d.full_name);
    ...
    var doccreate = Vue.component('doccreate', {
        template: require('./../html/files/docform.html'),
        mixins: [myMixin],
        props: ['show',   'currntfolder', 'docFormShow', 'folderlist', 'formAction', 'current_project', 'wp_nonce'],
        methods: {
    ...
    var googledoccreate = Vue.component('googledoccreate', {
        template: require('./../html/files/googledocform.html'),
        mixins: [myMixin],
        props: ['show',  'doclink', 'currentIcon', 'currntfolder', 'googleDocsForm', 'folderlist', 'formAction', 'current_project', 'wp_nonce'],
        methods: {
    ...
    var fileuploader = Vue.component('fileuploader', {
        ...
        ready: function () {
           this.uploaddc = new CPM_Uploader_Old('cpm-upload-pickfiles-dc', 'cpm-upload-container-dc');
           this.uploaddc.uploader.refresh();
        }

    });
    var prettyphoto = Vue.component('prettyphoto', {
    ...
    var onlinedocs = Vue.component('onlinedocs', {
    ...
    var blanktemplate = Vue.component('blanktemplate', {
    ...
    var dataloading = Vue.component('dataloading', {
    ...
    var vm = new Vue({
        ...
        data: function () {
            return {
                ...
                viewDocOrg: null,
                docRevisions: '',
                currentIcon: CPM_pro_files.base_url + "/assets/images/others.svg",
                modalwide: '400px',
        ...
        methods: {
            ...
            fileUploadShow: function () {
                ...
                setTimeout(function() {
                    ...
                    jQuery('#cpm-upload-container-nd .moxie-shim').css({ 'left': '0px', 'top':'0px'})
                },500);
            },
            ...
            createNewDoc: function () {
                ...
                setTimeout(function() {
                    jQuery('#cpm-upload-container-dc .moxie-shim').css({ 'left': '70px', 'top':'0px'})
                }, 500);
            },
