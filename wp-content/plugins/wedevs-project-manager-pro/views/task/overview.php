...
<div class="cpm-mytask-overview-page">
        ...
        <ul>
            ...
            <li>
                ...
                <span class="cpm-right task-count">
                    <?php printf( _n( '%s Task', '%s Tasks', $val, 'cpm-pro' ), number_format_i18n( $val ) ) ?>
                </span>
    ...
    <div class="cpm-mytask-chart-statistics cpm-col-9 cpm-sm-col-12 ">
        <h3 class="cpm-box-title"><?php _e( 'Activity', 'cpm-pro' ); ?></h3>

        <div class="">
            <div class="cpm-right">
                <span class="color-plate" style="background: #61BD4F"></span> <?php _e( 'Activity', 'cpm-pro' ); ?>
                <span class="color-plate" style="background: #590340"></span> <?php _e( 'Assigned', 'cpm-pro' ); ?>
                <span class="color-plate" style="background: #0090D9"></span> <?php _e( 'Completed', 'cpm-pro' ); ?>
                ...
                <select id="mytask-change-range">
                    <?php
                        ...
                        while ( $month <= $end ) {
                            $m =  date_i18n('F Y', $month);
                            $v = date_i18n('m,Y', $month) ;
...
<div class="cpm-mycalender">
    <div class="cpm-col-12 ">
            <h3 class="cpm-box-title"><?php _e( 'My Calender', 'cpm-pro' ); ?></h3>
