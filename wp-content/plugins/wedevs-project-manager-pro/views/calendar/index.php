...
?>
<?php
    $porjects = CPM_Project::getInstance()->get_all_project();
...
<form action="" method="post">
    ...
    <select name="project_id">
        ...
        ?>
    <select>
    <input type="submit" name="calender-project" value="<?php _e( 'Filter', 'cpm-pro' ); ?>" class="btn button-primary">
</form>
    ...
    jQuery(document).ready(function($) {
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            events: {
                ...
                error: function() {
                    alert('<?php _e( 'There was an error while fetching events!', 'cpm-pro' ); ?>');
                }
            },
            ...
            eventRender: function(event, element, calEvent) {
                ...
                if( event.img != 'undefined' && element.hasClass('cpm-calender-todo') ) {
                    ...
                    element.find('.fc-title').before( $("<span class=\"fc-event-icons\">"+event.img+"</span>") );
                }
            },
        ...
        function CpmUpdateStartEndMeata(event, revertFunc) {
            ...
            if(event.end != null) {
                ...
                var end_date = new Date( event.start );
                end_date = $.datepicker.formatDate('yy-mm-dd', end_date);
            }
            var data = {
