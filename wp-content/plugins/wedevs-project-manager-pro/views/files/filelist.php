    ...
    <li id="pro-<?php echo $file['id'] ?>">
        ...
        <div class="">
            ...
            <div class="cpm-file-meta">
                <?php // printf( __( 'Attached to <a href="%s">%s</a> by %s', 'cpm-pro' ), $topic_url, strtolower( $post_type_object ), cpm_url_user( $attachment->post_author ) ) ?>
            </div>
            ...
            <div class="cpm-file-action">
                <ul>
                    ...
                    if ( get_current_user_id() == $attachment->post_author ) {
                        ...
                        $privacy_title  = $is_private ? __( 'File is private. Click to make file public.', 'cpm-pro' ) : __( 'File is public. Click to make file private.' );
                        ?>
