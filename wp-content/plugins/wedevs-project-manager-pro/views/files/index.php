<?php cpm_get_header( __( 'Files', 'cpm-pro' ), $project_id ); ?>
...
<div class="cpm-pro-file-container" id="myapp"  v-cloak >
    ...
    <div  class="container">
        ...
        <doccreate
            :doc-form-show="docFormShow"
            :currntfolder="currntfolder"
            :current_project="current_project"
            :wp_nonce="wp_nonce"
            :form-action="formAction"
            ></doccreate>
        <googledoccreate
            :google-docs-form="googleDocsForm"
                ...
                <div class="ff-content">
                    ...
                    <div  v-if="file.type=='doc' || file.type=='google_doc' " class="cpm-doc-view" >
                        <div class="doc-content"  @click.prevent="readDoc(file)"  >
                            ...
                            <div class="item-title"> {{file.name}}</div>
                            <small>{{text.by}} <strong>{{file.created_name}}</strong></small>
                            <hr/>
                    ...
                    <div  v-if="file.type=='regular_doc_image' || file.type=='regular_doc_file' " class="cpm-rdoc-view" >
                        ...
                        <div class="footer-section">
                            ...
                            <a href="{{file.topic_url}}" class="cpm-comments-count"><span class="cpm-btn cpm-btn-blue cpm-comment-count">{{file.comment_count}}</span></a>
                        </div>
        ...
        <readdocmodal
            :current-icon="currentIcon"
            :show.sync="readDocModal"
            :view-doc="viewDoc"
            :doc-eidted="docEidted"
            :comments="comments"
            :current_project="current_project"
            :wp_nonce="wp_nonce"
            :private="viewDoc.private"
            :doc-revisions="docRevisions"
            :revision-mode="revisionMode"
            ></readdocmodal>
    </div>
    <blanktemplate v-if="emptyList" :text="text"></blanktemplate>
