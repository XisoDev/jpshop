    ...
    <div class="postbox">
        ...
        <div class=""   >
            ...
            if ( ! isset( $_GET['filter'] ) ) {
                ?>
                <h3 class="cpm-form-title"><span><?php _e( 'Advance Search Project', 'cpm-pro' ); ?></span></h3>
                ...
                ?>
                <h2 class="cpm-form-title"><span><?php _e( 'Advance Report Form', 'cpm-pro' ); ?></span></h2>
                <div class="cpm-postbox-wrap">
    ...
    <div id="cpm-report-table-wrap">
        ...
        if ( isset( $_GET['filter'] ) ) {
            ...
            if ( reset( $data['filter'] ) == '-1' ) {
                echo '<h3>';
                _e( 'Please select an filter!', 'cpm-pro' );
                echo '</h3>';
            ...
            $results = cpmpro()->report->report_generate( $data );
            
            if ( ! $results->posts ) {
                echo '<h3>';
                _e( 'No result found!', 'cpm-pro' );
                echo '</h3>';
                //close cpm-report-table-wrap before return
                echo '</div>';
                return;
            }
            echo cpmpro()->report->render_table( $results->posts, $data );
        }
        ?>
